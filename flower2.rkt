...
; URL base
(define base-url "https://www.bioexplorer.net/plants/flowers/")
...
(define paragraphs-string (get-paragraphs-as-string ((sxpath "//h3//text()") my-html) keyword))
...
(define output-file "flower2.html")
